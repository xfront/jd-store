...
public final class Const {
    ...
    // Dubbox版本
    public static final String JD_STORE_REDIS_VERSION  = "1.0.0";
    public static final String JD_STORE_SSO_VERSION    = "1.0.0";
    public static final String JD_STORE_NOTIFY_VERSION = "1.0.0";
    public static final String JD_STORE_ADMIN_VERSION  = "1.0.0";
    public static final String JD_STORE_SEARCH_VERSION = "1.0.0";
    public static final String JD_STORE_PORTAL_VERSION = "1.0.0";
    public static final String JD_STORE_ORDER_VERSION  = "1.0.0";
    public static final String JD_STORE_CART_VERSION   = "1.0.0";
    public static final String JD_STORE_ITEM_VERSION   = "1.0.0";
