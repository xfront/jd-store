...
define("TB_ROOT/js2", function (require, a, b) {
    var c = require("js2/login.js");
    ...
    f.prototype = {
        init: function () {
            ...
            var b = this;
            $.ajax({
                url: "//cart.jd.com/cart/miniCartServiceNew.action", data: a, dataType: "jsonp", success: function (c) {
