...
!function (e, t) {
    ...
    if (!e.seajs) {
        var E = e.seajs = {version: "2.2.0"}, A = E.data = {}, _ = r("Object"), j = r("String"),
            w = Array.isArray || r("Array"), x = r("Function"), T = 0, C = A.events = {};
        E.on = function (e, t) {
            var r = C[e] || (C[e] = []);
            return r.push(t), E
        }, E.off = function (e, t) {
        ...
        var S = E.emit = function (e, t) {
            ...
            q = /{([^{]+)}/g, O = /^\/\/.|:\//, I = /^.*?\/\/.*?\//, R = document, M = i(R.URL), G = R.scripts,
            L = R.getElementById("seajsnode") || G[G.length - 1], $ = i(d(L) || M);
        E.resolve = h;
        var K, Y, B = R.getElementsByTagName("head")[0] || R.documentElement, V = B.getElementsByTagName("base")[0],
            H = /\.css(?:\?|$)/i, P = +navigator.userAgent.replace(/.*AppleWebKit\/(\d+)\..*/, "$1") < 536;
        E.request = m;
        var X,
            z = /"(?:\\"|[^"])*"|'(?:\\'|[^'])*'|\/\*[\S\s]*?\*\/|\/(?:\\\/|[^\/\r\n])+\/(?=[^\/])|\/\/.*|\.\s*require|(?:^|[^$])\brequire\s*\(\s*(["'])(.+?)\1\s*\)/g,
            W = /\\\\/g, J = E.cache = {}, Q = {}, Z = {}, ee = {}, te = b.STATUS = {
                FETCHING: 1,
                SAVED: 2,
                LOADING: 3,
                LOADED: 4,
    ...
    var e = {
        getDownloadSpeed: function () {
            try {
                ...
                if (e) {
                    var t = $("html").html().length, n = t / 1024,
            ...
            var e = Math.floor(100 * Math.random()), t = this.getDownloadSpeed(), n = window.pageConfig || {},
                r = n && n.O2_REPORT;
            ...
            var e = window, t = window.pageConfig || {}, n = Math.floor(100 * Math.random()),
            ...
            if (!this._firstReport) {
                ...
                if (t || e) {
                    var n = this.getBaseData(), r = this.getBrowser(), o = this.getScreenRatio(), i = this.getSystem(),
                        a = [];
...
define("conf", function (require, exports, module) {
    "use strict";
    var e = "//www.3.cn/bup", o = "//f.3.cn/index-floor?argv=", t = "//www.3.cn/index/bak/", a = "//ai.jd.com",
        n = a + "/index_new.php?", r = "//ch.jd.com", i = "//diviner.jd.com/diviner", s = "//yuding.jd.com",
        l = "app=Seckill&action=pcIndexMiaoShaArea", d = "app=Newuser&action=isNewuser",
        c = "app=Discovergoods&action=getDiscZdmGoodsListForIndex", h = "app=ABdata&action=ABData&key=BtestData",
        u = pageConfig.dataLoadTimeout || 3e3, f = {
            TIMEOUT: u,
    ...
    var o = require("conf"), t = require("load_async"), a = window.pageConfig, n = a.FN_GetRandomData,
        r = a.processImageUrl, i = function (e) {
            ...
            before: {
                enjoy: function (e, a, n) {
                    ...
                    if (i && i.length && s && s.length) {
                        ...
                        $("#enjoy").addClass(l);
                        var p = o.DOMAINS.BI, _ = readCookie("__jda"), g = readCookie("areaId"),
                            m = readCookie("pin") || "";
    ...
    var s = window.pageConfig, l = _.Class.extend({
        statics: {
            ...
            var c = !0, h = "jsonCallBack_" + l, u = this.o2JSConfig.tplPathRule(l), f = d[l],
                p = s.tplLoadTimeout || 4e3;
            ...
            if (!this.loadingData[e]) {
                ...
                for (var u = 0, f = 0; f < d; f++) {
                    ...
                    var w = encodeURIComponent("jsonCallBack" + m), v = this.o2JSConfig.sourcePathRule(_),
                        E = this.w.sourceVersion[_];
                    if (t) {
