...
import cn.eshop.pojo.TbCategorySecondaryExample;
...
public interface TbCategorySecondaryMapper {
    ...
    int updateByExampleSelective(@Param("record") TbCategorySecondary record,
                                 @Param("example") TbCategorySecondaryExample example);

    int updateByExample(@Param("record") TbCategorySecondary record,
                        @Param("example") TbCategorySecondaryExample example);
