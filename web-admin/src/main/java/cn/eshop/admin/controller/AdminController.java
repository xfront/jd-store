...
import cn.eshop.admin.vo.ManageUserVO;
...
public class AdminController {
    ...
    public @ResponseBody
    Map<String, Object> getCategory(Model model, Integer sEcho, Integer iDisplayStart, Integer iDisplayLength) {
    ...
    public @ResponseBody
    Map<String, Object> getCategorySecondary(Model model, String sSearch, Integer sEcho, Integer iDisplayStart,
        ...
        if (StringUtils.isNotBlank(sSearch)) {
            ...
            Map<String, Object> lists = contentService.getSearchCategorySecondaryList(sSearch, sEcho, iDisplayStart,
                                                                                      iDisplayLength);
            return lists;
        }
    ...
    public @ResponseBody
    JDResult saveCategory(String id, String name, Integer sort_order) {
