package cn.eshop.admin.service.impl;

import cn.eshop.admin.service.ContentService;
import cn.eshop.mapper.TbCategoryMapper;
import cn.eshop.mapper.TbCategorySecondaryMapper;
import cn.eshop.pojo.*;
...
public class ContentServiceImpl implements ContentService {
    ...
    public JDResult saveCategory(String id, String name, Integer sort_order) {
        ...
        return i > 0 ? JDResult.ok() : JDResult.build(400, "更新失败！");
    }
    ...
    //@Transactional(isolation = Isolation.DEFAULT, propagation = Propagation.REQUIRED)
    public JDResult saveCategorySecondary(@RequestBody TbCategorySecondary categorySecondary) {

        categorySecondary.setUpdated(new Date());

        int i = categorySecondaryMapper.updateByPrimaryKeySelective(categorySecondary);

        return i > 0 ? JDResult.ok() : JDResult.build(400, "服务器出错!");
    }
}
