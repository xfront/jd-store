package cn.eshop.cart.service.impl;

import cn.eshop.cart.service.CartService;
import cn.eshop.mapper.TbItemMapper;
import cn.eshop.pojo.CartInfo;
import cn.eshop.pojo.TbItem;
import cn.eshop.pojo.TbItemExample;
...
public class CartServiceImpl implements CartService {
    ...
    public JDResult addCart(Long pid, Integer pcount, String uuid) {
        ...
        if (StringUtils.isNotBlank(redisItem)) {
            ...
            if (itemList != null && itemList.size() > 0) {
                ...
                return JDResult.build(500, "商品查询不到!");
            }
        }
        ...
        if (StringUtils.isBlank(cartInfoString)) {
            ...
            return JDResult.build(200, "ok", cartInfo);
    ...
    public JDResult decreOrIncre(Long pid, Integer pcount, Integer type, Integer index, String cookieUUID) {
        ...
        if (cartInfoList == null || cartInfoList.size() == 0) {
            return JDResult.build(400, "购物车没有此商品 请不要非法操作!");
        }
