package cn.eshop.order.service.impl;

import cn.eshop.constant.Const;
import cn.eshop.mapper.TbOrderItemMapper;
import cn.eshop.mapper.TbOrderMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public JDResult generateOrder(String userCookieValue, String cartCookieValue, Integer addrId, Integer noAnnoyance, Integer paymentType, String orderId, String shippingName) {
        ...
        JDResult result = userService.token(userCookieValue, "");
        if (result.getData() == null) {
            logger.error("用户没有登录!");
            return JDResult.build(400, "系统错误!");
        }
