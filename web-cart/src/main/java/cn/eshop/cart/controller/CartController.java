package cn.eshop.cart.controller;

import cn.eshop.cart.service.CartService;
import cn.eshop.constant.Const;
import cn.eshop.pojo.CartInfo;
import cn.eshop.pojo.TbUser;
import cn.eshop.pojo.JDResult;
import cn.eshop.utils.CookieUtils;
import cn.eshop.utils.FastJsonConvert;
...
public class CartController {
    ...
    public @ResponseBody
    String miniCartServiceNew(String callback) {

        String s =
                "{\"Cart\":{\"TheSkus\":[],\"TheGifts\":[],\"TheSuit\":[],\"ManJian\":[],\"ManZeng\":[{\"Id\":196031044\n" +
    ...
    @RequestMapping("/add")
    public String addCart(Long pid, Integer pcount, HttpServletRequest request, HttpServletResponse response,
                          Model model) {
        String cookieUUID = CookieUtils.getCookieValue(request, Const.CART_KEY);
        if (StringUtils.isBlank(cookieUUID)) {
            ...
            JDResult result = cartService.addCart(pid, pcount, uuid);
            ...
            JDResult result = cartService.addCart(pid, pcount, cookieUUID);
    ...
    public @ResponseBody
    JDResult decreOrIncre(Long pid, Integer pcount, Integer type, Integer index, HttpServletRequest request,
        ...
        if (StringUtils.isBlank(cookieUUID)) {
            ...
            return JDResult.build(400, "请先去购物!");
