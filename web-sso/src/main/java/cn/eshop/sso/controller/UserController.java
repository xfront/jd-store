package cn.eshop.sso.controller;
...
public class UserController {
    ...
    String login(TbUser user, String returnUrl, HttpServletResponse response, HttpServletRequest request) {
        ...
        JDResult result = userService.login(user);
    ...
    public @ResponseBody
    String regService(String regName, String pwd, String pwdRepeat, String phone, String mobileCode, String authCode,
                      String uuid) {
    ...
    public @ResponseBody
    String sendRegEmail(String regName, String pwdRepeat, String pwd, String phone, String mobileCode, String uuid,
                        String authCode, String email) {
